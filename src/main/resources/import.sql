...
--Insert a delayed lend
insert into LEND (id, expectedreturndate, lenddate, affiliate_id, copy_id, lendtype_id, lendinguser_id) values (3, '2013-10-15', '2013-10-10', 1, 1, 2, 1);
